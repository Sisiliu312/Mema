...
GQADIR="/home/data/shika/LLaVA/playground/data/eval/gqa"
...
output_file=/home/data/shika/LLaVA/playground/data/eval/gqa/answers/$SPLIT/$CKPT/merge.jsonl
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    cat /home/data/shika/LLaVA/playground/data/eval/gqa/answers/$SPLIT/$CKPT/${CHUNKS}_${IDX}.jsonl >> "$output_file"
done
