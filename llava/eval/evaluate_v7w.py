...
from llava.eval.data_provider import getDataProvider
...
if __name__ == '__main__':
  ...
  parser.add_argument('-r', '--dataset-root', default=None, type=str, help='directory containing dataset.json (default: datasets/<dataset>)')
  ...
  # load dataset (skipping feature files); allow custom dataset_root for dataset.json
  kwargs = {}
  if params.get('dataset_root'):
    kwargs['dataset_root'] = os.path.expanduser(params['dataset_root'])
  dp = getDataProvider(params['dataset'], **kwargs)
